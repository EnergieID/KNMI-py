...
"""
A setuptools based setup module for KNMI-py.
...
with open(path.join(here, 'knmi', 'knmi.py'), encoding='utf-8') as f:
    lines = f.readlines()
    for l in lines:
...
setup(
    ...
    url='https://github.com/energyid/knmi-py',
    author='EnergieID.be',
